CREATE DATABASE  IF NOT EXISTS `cef_db` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `cef_db`;
...
CREATE TABLE `tb_dadoscadastrais` (
  ...
  `razao` varchar(100) CHARACTER SET latin1 DEFAULT NULL,
  `ie` varchar(50) CHARACTER SET latin1 DEFAULT NULL,
  `im` varchar(50) CHARACTER SET latin1 DEFAULT NULL,
  ...
  `representante` varchar(50) CHARACTER SET latin1 DEFAULT NULL,
  `telefone` varchar(15) CHARACTER SET latin1 DEFAULT NULL,
  `telefone2` varchar(15) DEFAULT NULL,
  `email` varchar(50) CHARACTER SET latin1 DEFAULT NULL,
  `db_banco` varchar(100) CHARACTER SET latin1 DEFAULT NULL,
  `db_tipo` varchar(100) CHARACTER SET latin1 DEFAULT NULL,
  `db_agencia` varchar(6) CHARACTER SET latin1 DEFAULT NULL,
  `db_operador` varchar(3) CHARACTER SET latin1 DEFAULT NULL,
  `db_conta` varchar(20) CHARACTER SET latin1 DEFAULT NULL,
  PRIMARY KEY (`codigo`)
...
INSERT INTO `tb_dadoscadastrais` VALUES (1,'35.367.026/0001-57','AYÊ ARQUITETURA','FELIPE FERREIRA GANDRA ARQUITETURA','ISENTO','591052','RUA VIRGÍLIO MALTA, 17-76','SALA 55','VILA MESQUITA','BAURU','17014-440','SP','2019-10-29','FELIPE FERREIRA GANDRA','(14) 3245-7767','(14) 99829-0103','aye@ayearquitetura.com.br','CAIXA ECONÔMICA FEDERAL','Conta Corrente de Pessoa Jurídica','4184','003','1115-8');
...
CREATE TABLE `tb_os` (
  ...
  `atividade_cod` varchar(10) CHARACTER SET latin1 DEFAULT NULL,
  ...
  `nome_contato` varchar(100) CHARACTER SET latin1 DEFAULT NULL,
  `telefone_contato` varchar(15) CHARACTER SET latin1 DEFAULT NULL,
...
-- Dump completed on 2020-08-02 10:11:49
