...
namespace Fluxus.WinUI.View
{
    public partial class frmAgencias : Form
    {
        ...
        private void Listar()
        {
            try
            { 
                dgvAgencias.DataSource = new BankBranchService().GetAll();
        ...
        private void btnEditar_Click(object sender, EventArgs e)
        {
            ...
            BankBranch agencia = new BankBranchService().GetBy(Convert.ToInt32(dgvAgencias.CurrentRow.Cells["id"].Value));
