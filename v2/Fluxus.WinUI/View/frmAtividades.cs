...
namespace Fluxus.WinUI.View
{
    public partial class frmAtividades : Form
    {
        ...
        private void Listar()
        {
            try
            {
                dgvAtividades.DataSource = new ServiceService().ListarAtividades(false);
        ...
        private void btnEditar_Click(object sender, EventArgs e)
        {
            ...
            Service atividade = new ServiceService().GetBy(Convert.ToInt32(dgvAtividades.CurrentRow.Cells["id"].Value));
